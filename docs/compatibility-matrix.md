...
| P03D nearby secure-channel activation boundary | Deep extension over P03C; no new wire format | Contract implemented, runtime blocked | Typed account/device credential and roster binding, fresh-only AKE flights, opaque pending activation, durable replay acceptance and opaque Seal/Open channel interfaces exist. The profile is unassigned; no crypto, persistence, key material, production implementation or runtime registration is shipped. |
