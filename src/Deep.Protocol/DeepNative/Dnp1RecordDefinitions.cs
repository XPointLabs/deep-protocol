...
internal static class RecordDefinitions
{
    ...
    internal static RecordDefinition Dpa1 { get; } = Public(ProtocolMagic.DPA1, 1, 644, 644,
    ...
    internal static RecordDefinition Dpd1 { get; } = Public(ProtocolMagic.DPD1, 1, 776, 776,
    ...
    internal static RecordDefinition Drt1 { get; } = Unsigned(ProtocolMagic.DRT1, 1, 179, 179,
        [F("accountHash",32),F("targetKind",1),F("revocationHandle",32),F("targetGeneration",8),F("certificate",38),F("targetNotAfter",8)]);

    internal static RecordDefinition Drs1 { get; } = Public(ProtocolMagic.DRS1, 1, 356, 63844,
    ...
    internal static RecordDefinition Krt1 { get; } = Public(ProtocolMagic.KRT1, 1, 412, 412,
    ...
    internal static RecordDefinition Krf1 { get; } = Public(ProtocolMagic.KRF1, 1, 300, 300,
        [F("network",16),F("scope",1),F("accountHash",32),F("accountGeneration",8),F("generation",8),
         F("predecessor",38),F("oldKeyHash",32),F("effectiveAt",8),F("action",1),F("oldSignature",64)], 10);

    internal static RecordDefinition Dcm1 { get; } = Public(ProtocolMagic.DCM1, 1, 812, 812,
    ...
    internal static RecordDefinition Dra1 { get; } = Public(ProtocolMagic.DRA1, 1, 788, 788,
    ...
    internal static RecordDefinition Dwd1 { get; } = Public(ProtocolMagic.DWD1, 1, 1217, 1217,
    ...
    internal static RecordDefinition Dcp1 { get; } = Public(ProtocolMagic.DCP1, 1, 706, 706,
    ...
    internal static RecordDefinition Dcs1 { get; } = Public(ProtocolMagic.DCS1, 1, 839, 839,
    ...
    internal static RecordDefinition Dct1 { get; } = Public(ProtocolMagic.DCT1, 1, 414, 414,
    ...
    internal static RecordDefinition Dcn1 { get; } = Public(ProtocolMagic.DCN1, 1, 758, 2806,
    ...
    internal static RecordDefinition Dcq1 { get; } = Public(ProtocolMagic.DCQ1, 1, 375, 8805,
    ...
    internal static RecordDefinition Dhl1 { get; } = Public(ProtocolMagic.DHL1, 1, 710, 1734,
    ...
    internal static RecordDefinition Dcl1 { get; } = Public(ProtocolMagic.DCL1, 1, 409, 5623,
    ...
    internal static RecordDefinition Dwl1 { get; } = Protected(ProtocolMagic.DWL1, 708, 708,
    ...
    internal static RecordDefinition Drc1 { get; } = Protected(ProtocolMagic.DRC1, 482, 33554914,
    ...
    internal static RecordDefinition Dpl1 { get; } = Protected(ProtocolMagic.DPL1, 576, 576,
    ...
    internal static RecordDefinition Dbg1 { get; } = Protected(ProtocolMagic.DBG1, 296, 296,
    ...
    internal static RecordDefinition Rib1 { get; } = Protected(ProtocolMagic.RIB1, 772, 772,
    ...
    internal static RecordDefinition Xib1 { get; } = Protected(ProtocolMagic.XIB1, 452, 452,
    ...
    internal static RecordDefinition Dnr1 { get; } = Public(ProtocolMagic.DNR1, 1, 756, 756,
    ...
    internal static RecordDefinition Mrl2 { get; } = Unsigned(ProtocolMagic.MRL2, 2, 326, 326,
    ...
    internal static RecordDefinition Rip2 { get; } = Unsigned(ProtocolMagic.RIP2, 2, 573, 957,
    ...
    internal static RecordDefinition Dpc1 { get; } = Public(ProtocolMagic.DPC1, 1, 430, 680,
    ...
    internal static RecordDefinition Dpr1 { get; } = Public(ProtocolMagic.DPR1, 1, 408, 408,
    ...
    internal static RecordDefinition Dps1 { get; } = Public(ProtocolMagic.DPS1, 1, 444, 444,
        [F("network",16),F("sender",32),F("recipient",32),F("senderDpc",38),F("recipientDpc",38),F("requestId",32),
         F("dpr",38),F("mrr",38),F("issuedAt",8),F("expiresAt",8),F("signature",64)],11);

    internal static RecordDefinition Mrlc { get; } = Protected(ProtocolMagic.MRLC, 898, 16778114,
    ...
    internal static RecordDefinition Dpj1 { get; } = Protected(ProtocolMagic.DPJ1, 609, 609,
    ...
    internal static RecordDefinition Rrm1 { get; } = Public(ProtocolMagic.RRM1, 1, 332, 332,
    ...
    internal static RecordDefinition Rrl1 { get; } = Protected(ProtocolMagic.RRL1, 502, 502,
    ...
    internal static RecordDefinition Dwt1 { get; } = Public(ProtocolMagic.DWT1, 1, 714, 714,
    ...
    internal static RecordDefinition Dxr1 { get; } = Protected(ProtocolMagic.DXR1, 573, 573,
    ...
    private static void ValidateClosedScalars(ReadOnlySpan<byte> encoded, string magic)
    {
        switch (magic)
        {
            ...
            case ProtocolMagic.DPC1:
                ...
                break;
            case ProtocolMagic.DPR1:
                Exact16(Field(encoded, 9), 1, "DPR1 operation");
                break;
            case ProtocolMagic.DPJ1:
